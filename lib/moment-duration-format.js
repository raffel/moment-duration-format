...
(function (root, factory) {
    ...
    function durationFormat() {
        ...
        var formatValue = function (momentType, index) {
            ...
            if (momentType.isMaxValue) {
                ...
                if (precision < 0) {
                    ...
                    if (useSignificantDigits) {
                        if (trunc) {
                            momentType.value = truncate(momentType.wholeValue + momentType.decimalValue, significantDigits - momentType.wholeValue.toString().length);
                        } else {
                ...
                if (useSignificantDigits) {
                    ...
                    momentType.value = Math.round(truncate(momentType.wholeValue, significantDigits - momentType.wholeValue.toString().length));
            ...
            var bubbles = [
                {
                    type: "milliseconds",
                    targets: [
                        { type: "seconds", value: 1000 },
                        { type: "minutes", value: 60000 },
                        { type: "hours", value: 3600000 },
                        { type: "days", value: 86400000 },
                        { type: "weeks", value: 604800000 },
                        { type: "months", value: 2678400000 },
                        { type: "years", value: 31536000000 }
                    ]
                },
                {
                    type: "seconds",
        ...
        tokens = map(tokens, function (token) {
            ...
            if (isNegative && (momentType.value > 0 || find(stopTrim, momentType.type))) {
                out += "-";
                isNegative = false;
            }
